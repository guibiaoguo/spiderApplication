...
public class TaoBaoPageProcesser implements PageProcessor {
    ...
    private Site site = Site.me().setDomain("1688.com").setUserAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:35.0) Gecko/20100101 Firefox/35.0");
    ...
    public void process(Page page) {
        ...
        page.putField("address", page.getHtml().xpath("//*[@id=\"content\"]/div[2]/div/div[2]/div/div[1]/div[1]/div[1]/div/div[2]/div[7]/span[2]/text()"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        while(!StringUtils.equals(maps.get("code").toString(), "200")) {
            ...
            Thread.sleep(300);
            spiderJson = httpUtil.doGetForString("http://localhost:9090/testspider.json");
        ...
        jobJson = httpUtil.doGetForString("http://localhost:9090/test.json");

        objectMapper.configure(JsonParser.Feature.ALLOW_UNQUOTED_CONTROL_CHARS, true) ;
        JobDTO job = objectMapper.readValue(jobJson, JobDTO.class);
        Request request = new Request();
        request.setMethod("POST");
        request.setUrl("http://club.1688.com/");
